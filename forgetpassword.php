...
<div id="container">
 ...
 if(isset($_POST['submitMain']))
 {
  ...
  //echo $user;
  $get_user= mysqli_query($con,"SELECT log_fname,log_email,log_password FROM t_custreg_mst WHERE username= '$user' ")or die(mysqli_error());
  $num_user= mysqli_num_rows($get_user);
...
//   $password = @mysql_result($get_user,$i,'log_password');
 ...
 // mail function
  ...
  //echo $message;
   ...
   ini_set('sendmail_from','kasundimuthuwp@gmail.com');
