...
<div id="container">
          ...
          <table width="100%" border=0>
            <tr>
              ...
              <tr>
                 ...
                 <td width="128"><input value="<?php if (isset($_COOKIE["user"])){echo $_COOKIE["user"];}?>" type="textbox" name="txt_username" id="txt_username" maxlength="20" style="width:176px;"
              ...
              <tr>
                 ...
                 <td width="128"><input type="password" value="<?php if (isset($_COOKIE["pass"])){echo $_COOKIE["pass"];}?>" name="txt_password" id="txt_password" maxlength="20" style="width:176px;"
 ...
 if(isset($_POST['submitMain']))
 {
   ...
   $query = mysqli_query($con,"SELECT * FROM t_custreg_mst WHERE username = '$user'")
   or die(mysqli_error($con));
   if($get=mysqli_num_rows($query)>0)
   {
        if($row=mysqli_fetch_assoc($query)) {
            setcookie("user", $row['username'], time() + (604800));
            setcookie("pass", $row['log_password'], time() + (604800));
        }
       $_SESSION['user']=$user;
