        ...
        <table width="100%" border=0>
          <tr>
           ...
           <td><select name="selpid" id="selpid" style="width:180px;">
               ...
               <?php
                $get_pid= mysqli_query($con,"SELECT DISTINCT prd_id FROM t_orders_trn WHERE username= '$username' AND ord_deliverystatus= 'Delivered'")or die(mysqli_error());
...
//                 $odate= @mysql_result($get_date,$i,'ord_odate');
 ...
 <?php
  ...
  {
   $get= mysqli_query($con,"SELECT * FROM t_orders_trn WHERE username='$username' AND prd_id='$dpid' AND ord_deliverystatus= 'Delivered'")or die(mysqli_error());
...
//    $phone=@mysql_result($get,$i,'ord_phone');
 ...
 <?php
       ...
       {
	$get= mysqli_query($con,"SELECT * FROM t_orders_trn WHERE username='$username' AND ord_odate='$ddate' AND ord_deliverystatus= 'Delivered'")or die(mysqli_error());
        $num = mysqli_num_rows($get);
        while ($rows=mysqli_fetch_assoc($get))
//        for($i=0;$i<$num;$i++)
        {
...
//         $phone=@mysql_result($get,$i,'ord_phone');
 ...
 <?php
	...
	$get= mysqli_query($con,"SELECT * FROM t_orders_trn WHERE username='$username' AND prd_id='$dpid' AND ord_odate='$ddate' AND ord_deliverystatus= 'Delivered'")or die(mysqli_error());
        $num = mysqli_num_rows($get);
        while ($rows=mysqli_fetch_assoc($get))
//        for($i=0;$i<$num;$i++)
        {
