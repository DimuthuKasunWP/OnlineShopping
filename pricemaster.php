...
<div id="container">
  ...
  <div id="mainContent">
    ...
    <div id="middletxtheadermain">
      ...
      <div id="middletxt">
        <form action="pricemaster.php" method="post" name="frm_price" id="frm_price" enctype="multipart/form-data">
...
//                         $pid= @mysql_result($get_pid,$i,'prd_id');
                         $pid=$rows["prd_id"];
                         echo $pid."fdfjsalfdasjlfajsklfas";
                        ?>
...
//            $pedate=$_POST['txt_edate'];
            ...
            {
                $query = mysqli_query($con,"INSERT INTO t_price_mst(username,prd_id,price_actual,price_discount,price_discount_type)
                          VALUES ('$username','$pid','$pact','$pdis','$pdiscount')")
                or die(mysqli_error($con));
                echo "<script>alert('Price Details inserted sucessfully !!');</script>";
            } else {
                $query = mysqli_query($con,"UPDATE t_price_mst SET price_actual='$pact',price_discount='$pdis',price_discount_type='$pdiscount'
