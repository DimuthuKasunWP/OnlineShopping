              ...
              <td height="22"><table width="100%" border=0>
                  ...
                  <tr>
                    ...
                    <td><select name="selemail" id="selemail" style="width:300px;">
                        ...
                        <?php
                        $get_email= mysqli_query($con,"SELECT log_email FROM t_custreg_mst")or die(mysqli_error($con));
...
//                         $email= @mysql_result($get_email,$i,'log_email');
 ...
 <?php
  if(isset($_POST['submitMain']))
  {
   ...
   $get= mysqli_query($con,"SELECT * FROM t_admin_mst")or die(mysqli_error($con));
