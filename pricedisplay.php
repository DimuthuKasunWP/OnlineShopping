              ...
              <td height="22"><table width="100%" border=0>
                  ...
                  <tr>
                    ...
                    <td><select name="selpid" id="selpid" style="width:180px;">
                        ...
                        <?php
                        $get_pid= mysqli_query($con,"SELECT prd_id FROM t_price_mst WHERE username= '$username' ")or die(mysqli_error());
...
//                         $pid= @mysql_result($get_pid,$i,'prd_id');
 ...
 <?php
  ...
  {
   $pid=$_POST['selpid'];
   $get= mysqli_query($con,"SELECT * FROM t_price_mst WHERE username= '$username' AND prd_id='$pid' ")or die(mysqli_error());
