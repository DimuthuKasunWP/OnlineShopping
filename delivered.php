        ...
        <table width="100%" border=0>
          <tr>
           ...
           <td><select name="selpid" id="selpid" style="width:180px;">
               ...
               <?php
                 $get_pid= mysqli_query($con,"SELECT DISTINCT prd_id FROM t_orders_trn WHERE username= '$username' AND ord_deliverystatus= 'Delivered'")or die(mysqli_error($con));
...
//                 $odate= @mysql_result($get_date,$i,'ord_odate');
 ...
 $adjacents = 3;
	...
	if($page) 
 	...
 	$query=mysqli_query($con,"SELECT COUNT(*) as num FROM t_orders_trn WHERE username = '$username' AND ord_deliverystatus= 'Delivered'");
	...
	$get= mysqli_query($con,"SELECT * FROM t_orders_trn WHERE username='$username' AND ord_deliverystatus= 'Delivered' LIMIT $start, $limit ")or die(mysqli_error());
