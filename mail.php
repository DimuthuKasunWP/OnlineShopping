              ...
              <td height="22"><table width="100%" border=0>
                  ...
                  <tr>
                    ...
                    <td><select name="selemail" id="selemail" style="width:300px;">
                        ...
                        <?php
                        $get_email= mysqli_query($con,"SELECT DISTINCT ord_email FROM t_orders_trn WHERE username='$username' ")or die(mysqli_error($con));
                        $flag =mysqli_num_rows($get_email);
                        if ($flag != 0){
                        $num= mysqli_num_rows($get_email);
...
//                         $email= @mysql_result($get_email,$i,'ord_email');
			 ...
			 <option value="<?php echo $email;?>"><?php echo $email;?></option>
                        ...
                        $get_email= mysqli_query($con,"SELECT DISTINCT bck_email FROM t_backup_trn WHERE username='$username' ")or die(mysqli_error($con));
                        $num= mysqli_num_rows($get_email);
                        while ($rows=mysqli_fetch_assoc($get_email))
//                        for($i=0;$i<$num;$i++)
                        {
//                         $email= @mysql_result($get_email,$i,'bck_email');
                         $email=$rows["bck_email"];
                        ?>
			 <option value="<?php echo $email;?>"><?php echo $email;?></option>
                        <?php
                        }
